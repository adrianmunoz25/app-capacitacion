...
# --- CONFIGURACIÓN ---
NOMBRE_SHEET = "Resultados Capacitacion" # <--- Asegúrate que tu Excel se llame así
...
# --- SECCIÓN 1: LOS 3 PILARES (Tus criterios agrupados) ---
st.markdown("---")
...
# Pregunta dinámica según el promedio
pregunta_dinamica = ""
if promedio <= 3:
...
if st.button("Enviar Evaluación 🚀", type="primary"):
    if len(comentario) < 3 and promedio <= 3:
        st.error("Por favor, ayúdanos con un comentario breve sobre qué mejorar.")
    else:
        with st.spinner("Procesando tu feedback..."):
            try:
                # 1. CONEXIÓN A LA NUBE (SECRETOS)
                ...
                Puntajes (1-5): Comunicación={pilar_comunicacion}, Gestión={pilar_gestion}, Calidad={pilar_calidad}.
                Comentario: "{comentario}"
                
                Tu tarea:
                1. Clasifica el sentimiento (Positivo/Neutro/Negativo).
                2. Si hay quejas, clasifícala en: 'Atención', 'Claridad', 'Rapidez' o 'Proceso'. Si es elogio, pon 'Fortaleza'.
                3. Resume el comentario en máximo 5 palabras.
                
                Formato de respuesta: Sentimiento | Categoría | Resumen
                """
                ...
                st.write("Gracias por ayudarnos a crear mejores experiencias de aprendizaje.")
